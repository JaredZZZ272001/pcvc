...
import 'crear_noti_model.dart';
export 'crear_noti_model.dart';

class CrearNotiWidget extends StatefulWidget {
  const CrearNotiWidget({Key? key}) : super(key: key);

  @override
  _CrearNotiWidgetState createState() => _CrearNotiWidgetState();
}

class _CrearNotiWidgetState extends State<CrearNotiWidget> {
  late CrearNotiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearNotiModel());
                          ...
                          onPressed: () async {
                            var confirmDialogResponse = await showDialog<bool>(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title:
                                          Text('¿Deseas agregar esta noticia?'),
                                      content: Text(
                                          'Sera publica a todos los usuarios'),
                                      actions: [
                                        TextButton(
                            ...
                            if (confirmDialogResponse) {
                              final noticiasCreateData =
                                ...
                                nameN: _model.tituloController.text,
                                descripN: _model.descController.text,
                                fotoN: _model.uploadedFileUrl,
                              );
