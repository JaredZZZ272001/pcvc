...
import 'vc_pueb_model.dart';
export 'vc_pueb_model.dart';

class VcPuebWidget extends StatefulWidget {
  const VcPuebWidget({Key? key}) : super(key: key);

  @override
  _VcPuebWidgetState createState() => _VcPuebWidgetState();
}

class _VcPuebWidgetState extends State<VcPuebWidget>
    with TickerProviderStateMixin {
  late VcPuebModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VcPuebModel());
