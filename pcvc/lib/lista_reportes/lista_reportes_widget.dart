            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      'Revisa estas solicitudes de los ciudadanos',
                ...
                child: StreamBuilder<List<ReportesRecord>>(
                  stream: queryReportesRecord(
                    queryBuilder: (reportesRecord) =>
                        reportesRecord.where('status', isEqualTo: 'espera'),
                  ),
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network(
                                        'https://portal1.iff.edu.br/nossos-campi/macae/noticias/prorrogado-prazo-para-matricula-no-campus-macae/aviso.jpg/@@images/image.jpeg',
                                        width: 80.0,
                                        height: 80.0,
                                        fit: BoxFit.cover,
                                      ),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: AutoSizeText(
                                                listViewReportesRecord.usuarioRe
                                                    .maybeHandleOverflow(
                                                  maxChars: 70,
                                                  replacement: '…',
                                                ),
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            var confirmDialogResponse =
                                                await showDialog<bool>(
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          title: Text(
                                                              '¿Deseas omitir este reporte?'),
                                                          content: Text(
                                                              'Recuerda las reponsabilidades '),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
                                            ...
                                            if (confirmDialogResponse) {
                                              ...
                                              await listViewReportesRecord
                                                  .reference
                                                  .update(reportesUpdateData);
                                            }
                                          },
                                          child: Icon(
                                            Icons.delete,
